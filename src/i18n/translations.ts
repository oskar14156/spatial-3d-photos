...
export const TRANSLATIONS = {
  de: {
    ...
    import_retrieving_original: 'Original aus der Fotomediathek wird geladen …',
    ...
    import_platform_unsupported: 'Auf Android nicht unterstützt',
    import_platform_unsupported_body: 'Das ist eine Apple-Spatial-Aufnahme. Android bietet keine Schnittstelle, um die HEIC-Stereogruppen oder die zweite MV-HEVC-Ebene zu lesen. Side-by-Side-Bilder und zwei Einzelfotos funktionieren.',
    gallery_title: 'Galerie',
    gallery_scanning: 'Suche räumliche Aufnahmen …',
    gallery_manual: 'Manuell',
    gallery_filter: 'Filter',
    gallery_filter_all: 'Alle',
    gallery_filter_spatial: 'Räumlich',
    gallery_empty: 'Keine Fotos oder Videos gefunden.',
    gallery_no_spatial: 'Noch keine räumlichen Aufnahmen gefunden. Die Suche läuft, während du scrollst.',
    gallery_select_prompt: 'Wähle Aufnahmen aus',
    gallery_import_selected: '{count} importieren',
    gallery_import_all_spatial: 'Alle {count} räumlichen importieren',
    import_progress: 'Importiere {current} von {total} …',
    import_partial_title: 'Einige konnten nicht importiert werden',
    empty_library_title: 'Noch nichts hier',
    empty_library_body: 'Die Mediathek ist leer. Nimm ein Stereopaar auf oder hol dir welche aus deiner Fotogalerie.',
    empty_studio_title: 'Nichts zum Anzeigen',
    empty_studio_body: 'Sobald du etwas aufgenommen oder geöffnet hast, erscheint es hier in 3D.',
    action_open_gallery: 'Galerie öffnen',
    viewer_enter_fullscreen: 'Vollbild für Headset',
    viewer_exit_fullscreen: 'Vollbild verlassen',
    viewer_fullscreen_hint: 'Zum Beenden oben links tippen',
    viewer_eye_left: 'Links',
    viewer_eye_right: 'Rechts',
    viewer_tilt_hint: 'Neigen oder ziehen',
  ...
  en: {
    ...
    import_retrieving_original: 'Loading the original from Photos …',
    ...
    import_platform_unsupported: 'Not supported on Android',
    import_platform_unsupported_body: 'This is Apple spatial media. Android has no API for reading the HEIC stereo groups or the second MV-HEVC layer. Side-by-side images and two separate photos do work.',
    gallery_title: 'Gallery',
    gallery_scanning: 'Looking for spatial media …',
    gallery_manual: 'Manual',
    gallery_filter: 'Filter',
    gallery_filter_all: 'All',
    gallery_filter_spatial: 'Spatial',
    gallery_empty: 'No photos or videos found.',
    gallery_no_spatial: 'No spatial media found yet. The scan continues as you scroll.',
    gallery_select_prompt: 'Select items to import',
    gallery_import_selected: 'Import {count}',
    gallery_import_all_spatial: 'Import all {count} spatial',
    import_progress: 'Importing {current} of {total} …',
    import_partial_title: 'Some items could not be imported',
    empty_library_title: 'Nothing here yet',
    empty_library_body: 'Your library is empty. Capture a stereo pair, or pull some in from your photo gallery.',
    empty_studio_title: 'Nothing to show',
    empty_studio_body: 'Once you capture or open something, it appears here in 3D.',
    action_open_gallery: 'Open gallery',
    viewer_enter_fullscreen: 'Full screen for headset',
    viewer_exit_fullscreen: 'Exit full screen',
    viewer_fullscreen_hint: 'Tap top left to exit',
    viewer_eye_left: 'Left',
    viewer_eye_right: 'Right',
    viewer_tilt_hint: 'Tilt or drag',
