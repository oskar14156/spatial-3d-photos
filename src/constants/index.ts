...
export const DEMO_STEREO_PAIRS: StereoPair[] = [
  ...
  {
    id: 'demo_spatial_video_sample',
    title: 'iPhone Spatial Video 3D (Demo)',
    leftUri: 'https://d23dyxeqlo5psv.cloudfront.net/big_buck_bunny.mp4',
    rightUri: 'https://d23dyxeqlo5psv.cloudfront.net/big_buck_bunny.mp4',
    mediaType: 'video',
    sourceType: 'imported_spatial',
    isSpatialVideo: true,
    createdAt: Date.now() - 200000,
    description: 'iPhone 15 Pro / 16 Pro Spatial Video stereoscopic dual stream.',
    baselineDistanceMeters: 0.065,
    subjectDistanceMeters: 2.5,
    subjectCategory: 'room',
    alignment: { ...DEFAULT_ALIGNMENT },
    aspectRatio: 16 / 9,
  },
];
